            ...
            <div id="order_review" class="woocommerce-checkout-review-order">
                <table style="width:800px;">
                    ...
                    <tr style="text-align: center">
                        <th style="text-align: center"><label style="width: 200px; color: #565c65 !important; font-size: 26px !important; font-weight: 600 !important;">Product</label></th>
                        <th style="text-align: center"><label style="width: 200px; color: #565c65 !important; font-size: 26px !important; font-weight: 600 !important;">Total</label></th>
                        <th style="text-align: center"><label style="width: 200px; color: #565c65 !important; font-size: 26px !important; font-weight: 600 !important;">Offer</label></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
                        ...
                        if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_checkout_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
                            ?>
                            <tr align="center" class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                                <td class="product-name" align="center">
                                    <?php echo apply_filters( 'woocommerce_cart_item_name', $_product->get_title(), $cart_item, $cart_item_key ) . '&nbsp;'; ?>
                                    <?php echo apply_filters( 'woocommerce_checkout_cart_item_quantity', ' <strong class="product-quantity">' . sprintf( '&times; %s', $cart_item['quantity'] ) . '</strong>', $cart_item, $cart_item_key ); ?>
                                    <?php echo WC()->cart->get_item_data( $cart_item ); ?>
                                </td>
                                <td class="product-total" align="left">
                                    <label style="float: none!important; width: 200px; color: #565c65 !important; font-size: 26px !important; font-weight: 600 !important;"><?php echo WC()->cart->get_product_subtotal( $_product, $cart_item['quantity'] ); ?></label>
                                </td>
                                <td class="offer" style="align:center;">
                                    <?php $total = number_format($cart_item['line_subtotal'], 2); ?>
                                    <input style="width: 200px; color: #565c65 !important; font-size: 26px !important; font-weight: 600 !important;" type="text" name="offerValue[]" id="offerId" placeholder="<?php echo $total; ?>">
                    ...
                    <tr style="text-align: center">
                        ...
                        <td>
                            <label style="float: none!important; width: 200px; color: #565c65 !important; font-size: 26px !important; font-weight: 600 !important;">Total: <?php echo WC()->cart->get_total();?></label>
                        </td>
                        <td>
                            <label style="float: none!important; width: 200px; color: #565c65 !important; font-size: 26px !important; font-weight: 600 !important;">Offer: <?php echo WC()->cart->get_total();?></label>
                        </td>
                    </tr>
                    </tbody>
                </table>
