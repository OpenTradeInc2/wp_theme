...
add_action( 'woocommerce_proceed_to_purchase_order', 'woocommerce_button_proceed_to_purchase_order', 20 );
add_action( 'woocommerce_proceed_to_request_information', 'woocommerce_button_proceed_to_request_information', 20 );
add_action( 'woocommerce_proceed_to_post_offer', 'woocommerce_button_proceed_to_post_offer', 20 );
