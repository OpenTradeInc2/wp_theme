...
if ( ! function_exists( 'woocommerce_button_proceed_to_request_information' ) ) {
	 ...
	 * @subpackage	Cart
	 */
	function woocommerce_button_proceed_to_request_information() {
		wc_get_template( 'cart/proceed-to-request_more-information-button.php' );
	}
}

if ( ! function_exists( 'woocommerce_button_proceed_to_purchase_order' ) ) {
	 ...
	 * @subpackage	Cart
	 */
	function woocommerce_button_proceed_to_purchase_order() {
		wc_get_template( 'cart/proceed-to-purchase-order-button.php' );
	}
}

if ( ! function_exists( 'woocommerce_button_proceed_to_post_offer' ) ) {
	 ...
	 * @subpackage	Cart
	 */
	function woocommerce_button_proceed_to_post_offer() {
		wc_get_template( 'cart/proceed-to-post-offer-button.php' );
	}
}
