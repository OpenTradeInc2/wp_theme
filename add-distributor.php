    ...
    <div id="content" class="" style="width:100%;">
        ...
        if (isset($_GET['message-error'])) {
            ...
            <div id="message" class="error">
                <p style="color: red"><strong><?php _e($_GET['message-error']) ?></strong></p>
            </div>
            <?php
        }
        ?>
        ...
        <table align="center" style="width: 50%;">
            <tr>
                ...
                <td><input type="text" name="nameDistributor" class="gmw-address gmw-full-address gmw-address-1" value="<?php echo $_POST['nameDistributor'];?>"></td>
            </tr>
            <tr>
                <th style="width: 20%;">*Address</th>
                <td><textarea style="resize: none;" cols="58" class="gmw-address gmw-full-address gmw-address-1" rows="3" name="locationDistributor" value="<?php echo $_POST['locationDistributor'];?>"></textarea></td>
            </tr>
            <tr>
                <th scope="row" style="width: 20%;"><label for="locationDistributor">Tax Id: </label></th>
                <td><input type="text" name="taxIdDistributor" class="gmw-address gmw-full-address gmw-address-1" value="<?php echo $_POST['taxIdDistributor'];?>"></td>
            </tr>
            <tr>
                <th style="width: 20%;">*City:</th>
                <td><input type="text" name="city" class="gmw-address gmw-full-address gmw-address-1" value="<?php echo $_POST['city'];?>"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="zip_postal" class="gmw-address gmw-full-address gmw-address-1" value="<?php echo $_POST['zip_postal'];?>"></td>
            </tr>
            <tr>
        ...
        <table align="center" style="width: 50%;">
            <tr>
                ...
                <td><input type="text" name="first_name" class="gmw-address gmw-full-address gmw-address-1" value="<?php echo $_POST['first_name'];?>"></td>
            </tr>
            <tr>
                <th style="width: 20%;">*Your Last Name:</th>
                <td><input type="text" name="last_name" class="gmw-address gmw-full-address gmw-address-1" value="<?php echo $_POST['last_name'];?>"></td>
            </tr>
            <tr>
                <th scope="row" style="width: 20%;"><label for="email">Email <span class="description">(required)</span></label></th>
                <td><input name="email" id="email" type="email" class="input-text" value="<?php echo $_POST['email'];?>"></td>
            </tr>
            <tr>
                <th style="width: 20%;">Your Job Tittle:</th>
                <td><input type="text" name="tittle_job" class="gmw-address gmw-full-address gmw-address-1" value="<?php echo $_POST['tittle_job'];?>" class="gmw-address gmw-full-address gmw-address-1  "></td>
            </tr>
        ...
        if(isset($_POST["nameDistributor"]) and $_POST["nameDistributor"] !== ""){
            ...
            if($wpdb->check_connection()){
                ...
                if(isset($_POST["email"]) and $_POST["email"] !== ""){
                    ...
                    wc_add_notice('Please set valid email!','error');
                    header("Refresh:0");
                }
            }else{
                wc_add_notice('ERROR Data Base!','error');
                header("Refresh:0");
            }
        }
    }
